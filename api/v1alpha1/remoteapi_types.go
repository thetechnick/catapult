...
// RemoteAPISpec defines the desired state of RemoteAPI
type RemoteAPISpec struct {
	// INSERT ADDITIONAL SPEC FIELDS - desired state of cluster
	// Important: Run "make" to regenerate code after modifying this file

	// Foo is an example field of RemoteAPI. Edit RemoteAPI_types.go to remove/update
...
// RemoteAPI is the Schema for the remoteapis API
...
// RemoteAPIList contains a list of RemoteAPI
