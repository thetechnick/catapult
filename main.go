...
import (
	...
	"github.com/thetechnick/catapult/controllers"
...
func init() {
	...
	_ = catapultv1alpha1.AddToScheme(scheme)
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:   "524f7b83.thetechnick.ninja",
	})
	if err != nil {
	...
	if err = (&controllers.ServiceClusterReconciler{
		...
		setupLog.Error(err, "unable to create controller", "controller", "ServiceCluster")
		os.Exit(1)
	}
	if err = (&controllers.RemoteAPIReconciler{
		...
		setupLog.Error(err, "unable to create controller", "controller", "RemoteAPI")
		os.Exit(1)
	}
